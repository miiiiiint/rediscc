...
#define XMALLOC_HELPER_1AND2 \
  [[gnu::malloc, gnu::alloc_size( 1, 2 ), gnu::noinline]]
...
XMALLOC_NOT_MALLOC_HELPER_2 XMALLOC_EXTERN void*
extend_to_usable( void* ptr, size_t size );
